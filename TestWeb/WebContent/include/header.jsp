    ...
    <nav class="navbar navbar-default" id="nav">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li class="active"><a href="${pageContext.request.contextPath }/index.jsp" style="margin-right: 10px;">메인</a></li>
                <li><a href="${pageContext.request.contextPath }/board/bbs.bbs?pageNum=1&&amount=10">게시판</a></li>
            </ul>
